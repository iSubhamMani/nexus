      ...
      {items.map((item, idx) => (
        <div className="relative group" key={item.name}>
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 !p-0 object-top rounded-full h-[4.5rem] w-[4.5rem] border-2 group-hover:scale-105 group-hover:z-30 dark:border-white border-black relative transition duration-500"
          />
        </div>
      ))}
    </>
